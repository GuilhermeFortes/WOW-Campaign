...
public class mainTeste {
  ...
  static int escolhaPersonagem() {// Escolha o lado da batalha (100%)
    ...
    System.out.println(
        "Aliança: VocÃŠ vai ser um jovem soldado humano e vai  defender a cidade  das forÃ§as poderoÃ§a que marcham en direÃ§Ã£o a Vento Bravo");
  ...
  static int historiaAliança01() {// Historia introduÃ§Ã£o Aliança Etapa 1 (100%)
    Scanner er = new Scanner(System.in);
    ...
    System.out.println("HP - " + HP);
    System.out.println(
        "Entre eles o Sir Lothar um dos maiores comandante da Aliança e o Ãºnico da mÃªs que tinha enfrentados as novas ameÃ§as e saiu vivo e o Arch Mago Hadigar um iniciante de mago arcano e aluno da faculdade de Dalaran.");
    System.out.print("Aperte ENTER para continuar ou [i] - INVENTARIO: ");
    vazio = er.nextLine();
    if (vazio.equals("i")) {
      InventarioAliançaparte1();
    ...
    System.out.println("HP - " + HP);
    System.out.println(
        "Entre eles o Sir.Lothar um dos maiores comandante da Aliança e o Ãºnico que tinha enfrentado a nova ameÃ§a e saiu vivo para contar a historia e o Arch Mago Haddigar um iniciante de mago arcano e aluno da faculdade de Dalaran.");
    System.out.print("Aperte ENTER para continuar ou [i] - INVENTARIO: ");
    vazio = er.nextLine();
    if (vazio.equals("i")) {
      InventarioAliançaparte1();
  ...
  static void historiaQuedaDeVentoBravo() {
    ...
    System.out.println("HP - " + HP);
    System.out.println(
        "Todos:  Dou a minha vida e a minha honra Ã  Aliança, por esta noite e por todas as noites que estÃ£o para vir.");
    System.out.print("Aperte ENTER para continuar ou [i] - INVENTARIO: ");
    vazio = er.nextLine();
    if (vazio.equals("i")) {
      InventarioAliançaparte1();
